...
import 'package:store/app/services/storage_services/secure_storage_service.dart';
import 'package:store/app/services/storage_services/shared_prefrences_service.dart';
...
import 'package:store/domain/usecase/delete_account_usecase.dart';
...
import 'package:store/domain/usecase/get_notifications_usecase.dart';
import 'package:store/domain/usecase/get_product_detail_usecase.dart';
import 'package:store/domain/usecase/get_products_usecase.dart';
import 'package:store/domain/usecase/get_profile_usecase.dart';
import 'package:store/domain/usecase/get_unread_notifications_count_usecase.dart';
import 'package:store/domain/usecase/mark_all_notifications_read_usecase.dart';
import 'package:store/domain/usecase/open_ticket_usecase.dart';
...
import 'package:store/domain/usecase/remove_favorite_usecase.dart';
...
class DI {
  ...
  static final Provider<SessionService> _sessionService = Provider((ref) => SessionService(
                                              ref.read(_storageService),
                                              () async => null, // push removed (web-only build); no device token
