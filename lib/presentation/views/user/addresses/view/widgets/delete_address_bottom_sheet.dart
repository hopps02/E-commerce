...
/// Same confirm-sheet language as account deletion: handle, icon plate,
/// question, destructive + back actions.
class DeleteAddressBottomSheet extends StatelessWidget {
  const DeleteAddressBottomSheet({super.key});
  ...
  static Future<bool?> show(BuildContext context) async {
    return showModalBottomSheet<bool>(
      ...
      useSafeArea: true,
      builder: (context) => const DeleteAddressBottomSheet(),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            Translation.address_delete_confirm.tr,
