...
class CashierLanguageBottomSheet extends StatefulWidget {
  const CashierLanguageBottomSheet({super.key});
  ...
  static Future<void> show(BuildContext context) async {
    return showModalBottomSheet<void>(
      ...
      useSafeArea: true,
      builder: (_) => const CashierLanguageBottomSheet(),
    );
  }

  @override
  State<CashierLanguageBottomSheet> createState() =>
      _CashierLanguageBottomSheetState();
}

class _CashierLanguageBottomSheetState
    extends State<CashierLanguageBottomSheet> {
  Locale? _selected;
