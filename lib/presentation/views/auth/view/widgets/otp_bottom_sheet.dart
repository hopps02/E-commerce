...
class _OtpBottomSheetState extends ConsumerState<OtpBottomSheet> with AfterLayout {
  String _otp = '';
  ...
  void onVerifyOtp() {
    if (_otp.length == 5) {
      Navigator.pushReplacementNamed(context, RoutesManager.authSuccess.route);
    }
  }
