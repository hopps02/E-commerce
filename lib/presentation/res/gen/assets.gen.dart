...
class $AssetsLottieAnimationsGen {
  ...
  /// File path: assets/lottie_animations/globe.json
  LottieGenImage get globe =>
      const LottieGenImage('assets/lottie_animations/globe.json');
