...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderNumber,state,itemsCount,const DeepCollectionEquality().hash(items),const DeepCollectionEquality().hash(address),totals,totalHalalas,failureReason,createdAt);

@override
String toString() {
  return 'CustomerOrder(id: $id, orderNumber: $orderNumber, state: $state, itemsCount: $itemsCount, items: $items, address: $address, totals: $totals, totalHalalas: $totalHalalas, failureReason: $failureReason, createdAt: $createdAt)';
}
...
/// Create a copy of CustomerOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderNumber = null,Object? state = null,Object? itemsCount = freezed,Object? items = freezed,Object? address = freezed,Object? totals = freezed,Object? totalHalalas = freezed,Object? failureReason = freezed,Object? createdAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'order_number')  String orderNumber,  String state, @JsonKey(name: 'items_count')  int? itemsCount,  List<CustomerOrderItem>? items,  Map<String, dynamic>? address,  CustomerOrderTotals? totals, @JsonKey(name: 'total_halalas')  int? totalHalalas, @JsonKey(name: 'failure_reason')  String? failureReason, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CustomerOrder() when $default != null:
return $default(_that.id,_that.orderNumber,_that.state,_that.itemsCount,_that.items,_that.address,_that.totals,_that.totalHalalas,_that.failureReason,_that.createdAt);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderNumber,state,itemsCount,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(_address),totals,totalHalalas,failureReason,createdAt);
...
/// Create a copy of CustomerOrder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderNumber = null,Object? state = null,Object? itemsCount = freezed,Object? items = freezed,Object? address = freezed,Object? totals = freezed,Object? totalHalalas = freezed,Object? failureReason = freezed,Object? createdAt = freezed,}) {
